...
let mostrandoTexto = false; // Inicialmente, no estamos mostrando el texto
...
columna1.addEventListener('click', function () {
    if (mostrandoTexto) {
        ...
        mostrandoTexto = false; // Cambiamos el estado
    } else {
        ...
        mostrandoTexto = true; // Cambiamos el estado
    }
...
columna2.addEventListener('click', function () {
    if (mostrandoTexto) {
        ...
        mostrandoTexto = true;} columna2.style.cursor = 'pointer';});
...
columna3.addEventListener('click', function () {
    if (mostrandoTexto) {
        ...
        mostrandoTexto = true;} columna3.style.cursor = 'pointer';});
